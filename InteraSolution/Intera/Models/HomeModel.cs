...
namespace Intera.Models
{
    public class HomeModel : ModelBase
    {
        ...
        public void EnviarEmail(Pessoa p, Pessoa a, string nomePrj)
        {
            //valores
            string nomeRemetente = "INTERA";
            string emailRemetente = "interaproject2016@gmail.com";
            string assuntoMensagem = "Iniciação Científica";
            string conteudoMensagem = "Caro professor " + p.Nome + ", " +
                "o aluno " + a.Nome +
                " demonstrou interesse em participar na iniciação científica: " + nomePrj + ". Por favor entrar em contato com o aluno para que ele seja orientado. Email aluno: " + a.Email + ". Atenciosamente equipe INTERA.";
